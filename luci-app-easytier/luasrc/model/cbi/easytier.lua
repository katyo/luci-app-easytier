...
local devname = (model ~= "" and model) or (hostname ~= "" and hostname) or "OpenWrt"
devname = devname:gsub(" ", "_")
...
device_name.placeholder = devname
device_name.default = devname
device_name:depends("etcmd", "etcmd")
